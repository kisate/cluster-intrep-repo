...
unstack and stack should have two arguments, the block to be unstacked/stacked and the block it is unstacked/stacked from/on.
put down and pick up should have one argument, the block to be put down/picked up.
if you there is no second argument, use null.
...
Output:
{{"actions": [["stack", "B", "C"], ["unstack", "D", null], ["unstack", "A", null]]}}
...
Outpit:
{{"actions": [["unstack", "A", "D"], ["put down", "A"]]}}
...
parser.add_argument("--save_name", type=str, default="blocksworld-4-blocks-actions")
