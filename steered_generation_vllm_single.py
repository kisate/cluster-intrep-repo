...
def create_hook(phrases, action_phrases, masks_batch, mean_reprs, mean_actions, mean_predicates, scale=1):
    def hook(module, input, output):
        meta = getattr(module, "_meta", {})
        meta["n_seq"] = meta.get("n_seq", 0)
        positions = input[0]
        ...
        for ip, phrase in enumerate(phrases):
            ...
            steering_mask = masks_batch[phrase][n_seq]
