...
def process_domain(mystery_num, output_dir="charts"):
    ...
    repr_file = f"multilayer_representations_avg/multilayer_4k/mystery_{mystery_num}/mean_reprs_mystery_{mystery_num}.json"
    ...
    for layer in LAYERS:
        ...
        for step in steps:
            ...
            for phrase in unique_phrases:
                ...
                base_avg_vector = np.array(_avg_reprs[phrase]) - mean_domain
        ...
        df.to_csv(os.path.join(output_dir, f"avg_similarities_layer_{layer}.csv"), index=False)

if __name__ == "__main__":
    for mystery_num in trange(1, 16):
        out_dir = os.path.join("charts_data", "4k_avg", f"mystery_{mystery_num}")
